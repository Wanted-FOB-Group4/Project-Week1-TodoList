...
// }
  ...
  return ( 
    <span><DatePicker className={styles.date} withPortal dateFormat='yyyy/MM/dd' selected={startDate} onSelect={setSelectDates} onChange={date => handleDateChange(date)} /></span> 
  )
}
